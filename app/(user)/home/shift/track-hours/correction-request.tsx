...
const CorrectionRequest = () => {
    ...
    return (
        ...
        >
            ...
            <View>
                <Text className='font-proximanova-semibold text-sm text-primary dark:text-dark-primary mx-5 mt-4'>Select Dats</Text>
                <View className="mx-5 mt-2.5"><DatePicker /></View>
                <View
                    className={`flex-row justify-between gap-3 mx-5 mt-[15px]`}
                >

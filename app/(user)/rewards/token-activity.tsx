                    ...
                    <View className='flex-row gap-2'>
                        {
                            topTabs.map((tab, index) => (
                                <View key={index} className={` p-3 rounded-full ${isTabs === tab ? 'bg-[#4FB2F3]' : 'bg-[#eeeeee]'} `}>
                                    <Text
                                        onPress={() => setIsTabs(tab)}
                                        className={` text-sm  capitalize ${tab === isTabs ? 'text-[#ffff] font-proximanova-bold' : 'text-primary dark:text-dark-primary font-proximanova-semibold'} `}>{tab}</Text>
                                </View>
                            ))
                        }
                    </View>
                ...
                <View className='mx-5'>
                    ...
                    <View className='flex-row justify-between mt-3'>
                        <View className='flex-row gap-2.5 items-center'>
                            ...
                            <View>
                                <Text className='font-proximanova-semibold text-primary dark:text-dark-primary'>Complete 100% profile</Text>
                                <Text className='font-proximanova-regular text-sm text-secondary dark:text-dark-secondary'>2 January</Text>
                            </View>
                        </View>
                        <View className='flex-row gap-1.5 items-center'>
                            <Text className='font-proximanova-semibold text-lg text-[#3EBF5A]'>+80</Text>
                            <Image
                                source={require("@/assets/images/hiruu-coin.svg")}
                                style={{
                                    width: 22,
                    ...
                    <View className='flex-row justify-between mt-5'>
                        <View className='flex-row gap-2.5 items-center'>
                            <Image source={require('@/assets/images/reward/profile.svg')} contentFit='contain' style={{ width: 40, height: 40, }} />
                            <View>
                                <Text className='font-proximanova-semibold text-primary dark:text-dark-primary'>Featured Listing Fee</Text>
                                <Text className='font-proximanova-regular text-sm text-secondary dark:text-dark-secondary'>3 January</Text>
                            </View>
                        </View>
                        <View className='flex-row gap-1.5 items-center'>
                            <Text className='font-proximanova-semibold text-lg text-[#F34F4F]'>-800</Text>
                            <Image
                                source={require("@/assets/images/hiruu-coin.svg")}
                                style={{
                                    width: 22,
                    ...
                    <View className='flex-row justify-between mt-5'>
                        <View className='flex-row gap-2.5 items-center'>
                            <Image source={require('@/assets/images/reward/profile.svg')} contentFit='contain' style={{ width: 40, height: 40, }} />
                            <View>
                                <Text className='font-proximanova-semibold text-primary dark:text-dark-primary'>Gift 1 Month Premium to john</Text>
                                <Text className='font-proximanova-regular text-sm text-secondary dark:text-dark-secondary'>3 January</Text>
                            </View>
                        </View>
                        <View className='flex-row gap-1.5 items-center'>
                            <Text className='font-proximanova-semibold text-lg text-[#F34F4F]'>-300</Text>
                            <Image
                                source={require("@/assets/images/hiruu-coin.svg")}
                                style={{
                                    width: 22,

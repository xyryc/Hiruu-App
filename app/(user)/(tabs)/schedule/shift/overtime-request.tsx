                ...
                <View>
                    <FlatList
                        ...
                        renderItem={({ item }) => (
                            ...
                            >
                                <Text className={`text-center  ${filter == item.toLowerCase() ? 'text-white dark:text-dark-primary' : 'dark:text-dark-primary text-primary'}`}><Text className='capitalize'>{item}</Text> ( {getFilterCount(item.toLowerCase())} )</Text>
                            </TouchableOpacity>
                        )}
                    />
                </View>
